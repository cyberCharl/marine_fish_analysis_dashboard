# marine_fish_analysis_dashboard
...
│                         marine_fish_analysis_dashboard and configuration for tools like black
│
...
│
└── marine_fish_analysis_dashboard   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes marine_fish_analysis_dashboard a Python module
    │
